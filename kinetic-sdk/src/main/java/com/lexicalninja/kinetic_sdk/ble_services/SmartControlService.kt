package com.lexicalninja.kinetic_sdk.ble_services

import android.bluetooth.BluetoothGattCharacteristic
import android.bluetooth.BluetoothGattService
import android.util.Log
import com.lexicalninja.kinetic_sdk.smartcontrol.ConfigData
import com.lexicalninja.kinetic_sdk.smartcontrol.PowerData
import com.lexicalninja.kinetic_sdk.smartcontrol.SmartControl
import com.lexicalninja.kotlinsensors.*
import com.lexicalninja.kotlinsensors.services.DeviceInformationService
    ...
    private var targetWatts by Delegates.observable<Long?>(null) { _, old, new ->
        new?.takeIf { controlPoint != null }?.apply {
            ...
            try {
                ...
                Log.d("SC Service", e.localizedMessage ?: "Unknown Message")
            }
        }
    }
...
//        }
    ...
    open class Measurement(service: WeakReference<BleService>, gattCharacteristic: BluetoothGattCharacteristic)
        ...
        open var powerData by Delegates.observable<PowerData?>(null) { _, _, new ->
